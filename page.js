...
export default function Home() {
  const [title, setTitle] = useState("Hlimpuii will you pleasee go out with me?");
  ...
  const yesButtonHandler = (event) => {
    ...
    if (event.target.innerText === "let's fix a time and place ASAP! 🥰") {
      window.open("https://wa.me/8798766300?text=Hey%2C%20I%20saw%20your%20website%2C%20that%20was%20so%20sweet!%20I%20would%20love%20to%20go%20out%20with%20you");
    }
  };
